export function AllComponents() {
    return (
        <>
                    ...
                    <div className="row">
                        <div className="col-lg-6">
                            <div className="zuzu-video-thumb4 wow fadeInUpX" data-wow-delay="0.10s">
                                <img src="assets/images/all-img/v4/video-thumb.png" alt="" />
                                <a className="zuzu-popup" href="https://www.youtube.com/watch?v=7e90gBu4pas">
                                    <img src="assets/images/all-img/v4/play-button.png" alt="" />
                        ...
                        <div className="col-lg-6 d-flex align-items-center">
                            <div className="zuzu-default-content">
                                ...
                                <p>Our mission is to help clients ensure the integrity of the space continues to improve by providing them with a full of service to help them launch their projects..</p>
                                <p>All our NFTs are tied to our unique rewards structure, meaning that as a long as you hold them in your wallet you’ll earn rewards, forever.</p>
                                <div className="zuzu-btn-wrap">
                                    <a className="zuzu-btn zuzu-icon-btn2 wow fadeInUpX" data-wow-delay="0.20s" href="">Discover more <img src="assets/images/svg/arrow-right-white.svg" alt="contact-light.html" /></a>
                                </div>
            ...
            <div className="section zuzu-section-padding3">
                <div className="container">
                    <div className="zuzu-section-title large">
                        <h5>Our unique services</h5>
                        <h2 className="font-black">We offer a wide range of services in crypto and NFT projects</h2>
                    </div>
                    <div className="row">
                        <div className="col-xl-3 col-lg-4 col-md-6">
                            <div className="zuzu-iconbox-wrap3 wow fadeInUpX" data-wow-delay="0s">
                                <div className="zuzu-iconbox-icon3">
                                    <img src="assets/images/all-img/v4/icon4.png" alt="" />
                                </div>
                                <div className="zuzu-iconbox-data3">
                                    <h5>Digital art production</h5>
                                    <p>Develop your creative technical skills in digital contentWith the universal appeal of digital art.</p>
                                    <a className="zuzu-icon-btn3" href="contact-light.html">
                        ...
                        <div className="col-xl-3 col-lg-4 col-md-6">
                            <div className="zuzu-iconbox-wrap3 wow fadeInUpX" data-wow-delay="0.10s">
                                <div className="zuzu-iconbox-icon3">
                                    <img src="assets/images/all-img/v4/icon5.png" alt="" />
                                </div>
                                <div className="zuzu-iconbox-data3">
                                    <h5>NFT brand marketing</h5>
                                    <p>NFT marketing promoting your NFTs across predetermined NFT marketplaces and blockchain</p>
                                    <a className="zuzu-icon-btn3" href="contact-light.html">
                                        <svg width="16" height="14" viewBox="0 0 16 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M8.29289 0.292893C8.68342 -0.0976311 9.31658 -0.0976311 9.70711 0.292893L15.7071 6.29289C16.0976 6.68342 16.0976 7.31658 15.7071 7.70711L9.70711 13.7071C9.31658 14.0976 8.68342 14.0976 8.29289 13.7071C7.90237 13.3166 7.90237 12.6834 8.29289 12.2929L12.5858 8L1 8C0.447716 8 0 7.55229 0 7C0 6.44772 0.447716 6 1 6H12.5858L8.29289 1.70711C7.90237 1.31658 7.90237 0.683418 8.29289 0.292893Z" fill="white" />
                                        </svg>
                        ...
                        <div className="col-xl-3 col-lg-4 col-md-6">
                            <div className="zuzu-iconbox-wrap3 wow fadeInUpX" data-wow-delay="0.20s">
                                <div className="zuzu-iconbox-icon3">
                                    <img src="assets/images/all-img/v4/icon6.png" alt="" />
                                </div>
                                <div className="zuzu-iconbox-data3">
                                    <h5>Contract build</h5>
                                    <p>If you're starting a new project, finding developers you can trust and have a proven track record.</p>
                                    <a className="zuzu-icon-btn3" href="contact-light.html">
                                        <svg width="16" height="14" viewBox="0 0 16 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M8.29289 0.292893C8.68342 -0.0976311 9.31658 -0.0976311 9.70711 0.292893L15.7071 6.29289C16.0976 6.68342 16.0976 7.31658 15.7071 7.70711L9.70711 13.7071C9.31658 14.0976 8.68342 14.0976 8.29289 13.7071C7.90237 13.3166 7.90237 12.6834 8.29289 12.2929L12.5858 8L1 8C0.447716 8 0 7.55229 0 7C0 6.44772 0.447716 6 1 6H12.5858L8.29289 1.70711C7.90237 1.31658 7.90237 0.683418 8.29289 0.292893Z" fill="white" />
                                        </svg>
                        ...
                        <div className="col-xl-3 col-lg-4 col-md-6">
                            <div className="zuzu-iconbox-wrap3 wow fadeInUpX" data-wow-delay="0.30s">
                                <div className="zuzu-iconbox-icon3">
                                    <img src="assets/images/all-img/v4/icon4.png" alt="" />
                                </div>
                                <div className="zuzu-iconbox-data3">
                                    <h5>Marketplace strategy</h5>
                                    <p>Most marketplace founders make the mistake of focusing on small niche & hoping it blow up.</p>
                                    <a className="zuzu-icon-btn3" href="contact-light.html">
                                        <svg width="16" height="14" viewBox="0 0 16 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M8.29289 0.292893C8.68342 -0.0976311 9.31658 -0.0976311 9.70711 0.292893L15.7071 6.29289C16.0976 6.68342 16.0976 7.31658 15.7071 7.70711L9.70711 13.7071C9.31658 14.0976 8.68342 14.0976 8.29289 13.7071C7.90237 13.3166 7.90237 12.6834 8.29289 12.2929L12.5858 8L1 8C0.447716 8 0 7.55229 0 7C0 6.44772 0.447716 6 1 6H12.5858L8.29289 1.70711C7.90237 1.31658 7.90237 0.683418 8.29289 0.292893Z" fill="white" />
                                        </svg>
                        ...
                        <div className="col-xl-3 col-lg-4 col-md-6">
                            <div className="zuzu-iconbox-wrap3 wow fadeInUpX" data-wow-delay="0.40s">
                                <div className="zuzu-iconbox-icon3">
                                    <img src="assets/images/all-img/v4/icon3.png" alt="" />
                                </div>
                                <div className="zuzu-iconbox-data3">
                                    <h5>Auditing provides</h5>
                                    <p>Our team will perform a full audit on your smart contract to ensure all security measures.</p>
                                    <a className="zuzu-icon-btn3" href="contact-light.html">
                                        <svg width="16" height="14" viewBox="0 0 16 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M8.29289 0.292893C8.68342 -0.0976311 9.31658 -0.0976311 9.70711 0.292893L15.7071 6.29289C16.0976 6.68342 16.0976 7.31658 15.7071 7.70711L9.70711 13.7071C9.31658 14.0976 8.68342 14.0976 8.29289 13.7071C7.90237 13.3166 7.90237 12.6834 8.29289 12.2929L12.5858 8L1 8C0.447716 8 0 7.55229 0 7C0 6.44772 0.447716 6 1 6H12.5858L8.29289 1.70711C7.90237 1.31658 7.90237 0.683418 8.29289 0.292893Z" fill="white" />
                                        </svg>
                        ...
                        <div className="col-xl-3 col-lg-4 col-md-6">
                            <div className="zuzu-iconbox-wrap3 wow fadeInUpX" data-wow-delay="0.50s">
                                <div className="zuzu-iconbox-icon3">
                                    <img src="assets/images/all-img/v4/icon9.png" alt="" />
                                </div>
                                <div className="zuzu-iconbox-data3">
                                    <h5>Contract build</h5>
                                    <p>If you're starting a project, finding developers you can trust and have a proven track record.</p>
                                    <a className="zuzu-icon-btn3" href="contact-light.html">
                                        <svg width="16" height="14" viewBox="0 0 16 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M8.29289 0.292893C8.68342 -0.0976311 9.31658 -0.0976311 9.70711 0.292893L15.7071 6.29289C16.0976 6.68342 16.0976 7.31658 15.7071 7.70711L9.70711 13.7071C9.31658 14.0976 8.68342 14.0976 8.29289 13.7071C7.90237 13.3166 7.90237 12.6834 8.29289 12.2929L12.5858 8L1 8C0.447716 8 0 7.55229 0 7C0 6.44772 0.447716 6 1 6H12.5858L8.29289 1.70711C7.90237 1.31658 7.90237 0.683418 8.29289 0.292893Z" fill="white" />
                                        </svg>
                        ...
                        <div className="col-xl-3 col-lg-4 col-md-6">
                            <div className="zuzu-iconbox-wrap3 wow fadeInUpX" data-wow-delay="0.60s">
                                <div className="zuzu-iconbox-icon3">
                                    <img src="assets/images/all-img/v4/icon10.png" alt="" />
                                </div>
                                <div className="zuzu-iconbox-data3">
                                    <h5>Emergency rebuild</h5>
                                    <p>If for any reason we do find high risk issue in the contract close to your launch, we can assess.</p>
                                    <a className="zuzu-icon-btn3" href="contact-light.html">
                                        <svg width="16" height="14" viewBox="0 0 16 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M8.29289 0.292893C8.68342 -0.0976311 9.31658 -0.0976311 9.70711 0.292893L15.7071 6.29289C16.0976 6.68342 16.0976 7.31658 15.7071 7.70711L9.70711 13.7071C9.31658 14.0976 8.68342 14.0976 8.29289 13.7071C7.90237 13.3166 7.90237 12.6834 8.29289 12.2929L12.5858 8L1 8C0.447716 8 0 7.55229 0 7C0 6.44772 0.447716 6 1 6H12.5858L8.29289 1.70711C7.90237 1.31658 7.90237 0.683418 8.29289 0.292893Z" fill="white" />
                                        </svg>
                        ...
                        <div className="col-xl-3 col-lg-4 col-md-6">
                            <div className="zuzu-iconbox-wrap3 wow fadeInUpX" data-wow-delay="0.70s">
                                <div className="zuzu-iconbox-icon3">
                                    <img src="assets/images/all-img/v4/icon11.png" alt="" />
                                </div>
                                <div className="zuzu-iconbox-data3">
                                    <h5>Website build</h5>
                                    <p>You'll be pleased to know that we offer website design and to development to help kickstart.</p>
                                    <a className="zuzu-icon-btn3" href="contact-light.html">
                                        <svg width="16" height="14" viewBox="0 0 16 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M8.29289 0.292893C8.68342 -0.0976311 9.31658 -0.0976311 9.70711 0.292893L15.7071 6.29289C16.0976 6.68342 16.0976 7.31658 15.7071 7.70711L9.70711 13.7071C9.31658 14.0976 8.68342 14.0976 8.29289 13.7071C7.90237 13.3166 7.90237 12.6834 8.29289 12.2929L12.5858 8L1 8C0.447716 8 0 7.55229 0 7C0 6.44772 0.447716 6 1 6H12.5858L8.29289 1.70711C7.90237 1.31658 7.90237 0.683418 8.29289 0.292893Z" fill="white" />
                                        </svg>
            ...
            <div className="zuzu-text-slider-section bg-pink-400">
                <div className="zuzu-text-slider">
                    <div className="zuzu-text-slider-data">
                        <div className="zuzu-text-slider-icon icon-rotate">
                            <img src="assets/images/all-img/v4/star.png" alt="" />
                        </div>
                    ...
                    <div className="row">
                        <div className="col-lg-5 offset-lg-1 order-lg-2">
                            <div className="zuzu-card-slider2">
                                <div className="zuzu-card-slider-item">
                                    <img src="assets/images/all-img/v4/card1.png" alt="" />
                                </div>
                                <div className="zuzu-card-slider-item">
                                    <img src="assets/images/all-img/v4/card2.png" alt="" />
                                </div>
                                <div className="zuzu-card-slider-item">
                                    <img src="assets/images/all-img/v4/card3.png" alt="" />
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-6 col-md-10 d-flex align-items-center">
                            <div className="zuzu-default-content">
                                ...
                                <p>It’s important to do your own research before investing in non-fungible tokens. These projects can be hard to value, and many NFTs are illiquid and selling your collectible in the future.</p>
                                <div className="zuzu-icon-list">
                                    <ul>
                                        <li><img src="assets/images/svg/check1.svg" alt="" />50% transaction fees allocated to the global staking pool</li>
                                        <li><img src="assets/images/svg/check1.svg" alt="" />Strong fan base established on multiple social platform</li>
                                        <li><img src="assets/images/svg/check1.svg" alt="" />Safe and secure to the extra benefits for NFTS stakers </li>
                                    </ul>
                                </div>
                            </div>
                        </div>
            ...
            <div className="section zuzu-section-padding3">
                <div className="container">
                    <div className="zuzu-section-title">
                        <h5>Meet our creative team</h5>
                        <h2 className="font-black">Dedicated team for your NFTs project launch</h2>
                    </div>
                    <div className="row">
                        <div className="col-lg-4 col-md-6">
                            <div className="zuzu-team-wrap wow fadeInUpX" data-wow-delay="0s">
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="zuzu-team-wrap wow fadeInUpX" data-wow-delay="0.10s">
                                <div className="zuzu-team-thumb">
                        ...
                        <div className="col-lg-4 col-md-6 offset-lg-0 offset-md-3">
                            <div className="zuzu-team-wrap wow fadeInUpX" data-wow-delay="0.20s">
                                <div className="zuzu-team-thumb">
                        ...
                        <div className="accordion-item">
                            <h2 className="accordion-header" id="headingThree">
                                <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                    Where will I be able to see my NFT's?
                                </button>
                            </h2>
                    ...
                    <div className="zuzu-cta2-wrap">
                        <div className="zuzu-section-title dark large mb-0">
                            ...
                            <div className="zuzu-cta-footer">
                                <a className="zuzu-btn zuzu-icon-btn2 white-icon-btn wow fadeInUpX" data-wow-delay="0.20s" href="contact-light.html">Get started now <img src="assets/images/svg/arrow-right-black.svg" alt="" /></a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div className="col-xl-3">
                                <div className="zuzu-textarea">
                                    ...
                                    <div className="zuzu-social-icon">
                                        <ul>
                                            <li><a href=""><img src="assets/images/social/twitter.svg" alt="" /></a></li>
                                            <li><a href=""><img src="assets/images/social/linkedin.svg" alt="" /></a></li>
                                            <li><a href=""><img src="assets/images/social/icon.svg" alt="" /></a></li>
                                            <li><a href=""><img src="assets/images/social/github.svg" alt="" /></a></li>
                                            <li><a href=""><img src="assets/images/social/plne.svg" alt="" /></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-xl-3 col-lg-5 col-md-6">
                                <div className="zuzu-footer-menu">
                                    ...
                                    <div className="zuzu-footer-subscribe">
                                        ...
                                        <button type="submit" id="zuzu-footer-subscribe-btn">Subscribe</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="zuzu-footer-bottom">
                        <div className="row">
                            <div className="col-lg-6 col-md-8">
                                <p>&copy; Copyright 2023, All Rights Reserved by favdevs</p>
                            </div>
